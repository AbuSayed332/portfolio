          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:abusayed@example.com" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm">+880 123 456 7890</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
